...
<header>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target="_blank" data-toggle="tooltip" data-placement="bottom"
                           title="Пошта ДРС" href="https://mail.drs.gov.ua/owa/#path=/mail" rel="external"><i
                                    class="fa fa-file"></i>
                            <!-- Пошта ДРС -->
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tooltip" data-placement="bottom" title="Телефонний довідник"
                           href="<?php echo get_template_directory_uri() . ('/content/tel-drs.html') ?>"
    ...
    <div class="sidebar-fixed position-fixed">
        ...
        <a class="btn btn-warning btn-lg menu-btn"
           href="<?php echo get_template_directory_uri() . ('/content/tel-drs.html') ?>" target="_blank">ДОВІДНИК
            ТЕЛЕФОНІВ</button></a>
        <br>
        <div class="custom">
            <?php
